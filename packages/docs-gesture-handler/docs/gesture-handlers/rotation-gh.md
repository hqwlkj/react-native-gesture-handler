...
See the [scale and rotation example](https://github.com/software-mansion/react-native-gesture-handler/blob/main/apps/common-app/src/recipes/scaleAndRotate/index.tsx) from Gesture Handler Example App.
